...
export default function Checkout() {
  ...
  const getUnitBasePrice = useCallback((item) => {
  ...
  const getUnitCurrency = useCallback((item) => {
    const product = productMap.get(item.id);
  ...
  }, [cart, productMap, province, postal, lang, targetCurrency, getUnitBasePrice, getUnitCurrency]);
